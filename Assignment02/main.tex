...
\begin{document}
    ...
    \begin{questions}
        ...
        \begin{parts}
            ...
            \begin{solution}
                We want to show that $\alpha$ lies on a sphere of radius $r \iff \rho^2 + (\rho'\sigma)^2 = r^2$.
                First suppose that $\alpha$ lies on a sphere of radius $r$. Then we have show that
                \begin{align*}
                    r^2 &= (-\rho N - \rho'\sigma B)^2 \\
                    &= \rho^2 + (\rho' \sigma)^2
                \end{align*}
                Differentiating both sides we get that
                \begin{align*}
                    0 &= 2\rho\rho' + 2(\rho'\sigma)(\rho'' + \rho'\sigma') \\
                    &=
                \end{align*}
            \end{solution}
        \end{parts}
